...
- (void)handleGesture:(UIPanGestureRecognizer *)recognizer {
    ...
    if (recognizer.state == UIGestureRecognizerStateBegan) {
        ...
        [self
            animateAlongsideTransition:^void(id context) {
...
- (BOOL)animateAlongsideTransition:
            (void (^)(id<UIViewControllerTransitionCoordinatorContext> context))animation
                        completion:
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    //    CGPoint fromSharedViewFrameOrigin =
    //        [topViewContent.superview convertPoint:topViewContent.frame.origin
    //                                        toView:fromVC.view];
    //    CGRect fromOriginRect = CGRectMake(
    //        fromSharedViewFrameOrigin.x, fromSharedViewFrameOrigin.y,
    //        topViewContent.frame.size.width,
    //        topViewContent.frame.size.height);
    ...
    //    [UIView
    //        animateKeyframesWithDuration:(NSTimeInterval)[self
